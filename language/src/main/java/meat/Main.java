...
public class Main {
	...
	// @formatter:off
		...
		"		1",
		"	] ifFalse: [",
		"		subContext1 object: (context newIsolatedContextBelow)",
		"		subContext1 at: 'f' put: f",
		"		subContext2 object: (context newIsolatedContextBelow)",
		"		subContext2 at: 'f' put: f",
		"		(f evaluateWith: {",
		"			i - 2",
		"		} in: subContext1) + (f evaluateWith: {",
		"			i - 1",
		"		} in: subContext2)",
		"	]",
		"]",
